...
export function BCAProjects() {
  const [projects, setProjects] = useState<BCAProject[]>([
    {
      id: 'proj-1',  // Changed from '1' to match businessUnitsData
      name: 'Q1 2024 Carbon Assessment',
      description: 'Office operations and manufacturing carbon footprint',
      year: 2024,
    ...
    {
      id: 'proj-2',  // Changed from '2' to match businessUnitsData
      name: 'Annual Sustainability Report 2023',
      description: 'Company-wide carbon footprint assessment',
      year: 2023,
      assignedBUs: ['bu-4', 'bu-5', 'bu-6', 'bu-7', 'bu-8', 'bu-9'],
      status: 'completed',
