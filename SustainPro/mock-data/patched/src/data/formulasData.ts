...
export const masterFormulas: FormulaDefinition[] = [
  ...
  // ============================================
  // FORMULA 10: Refrigerant Leakage  (dedicated, replaces proxy use of Natural Gas)
  // ============================================
  {
    id: 'form-ref-fug',
    uid: 'FORM-REF-FUG-2024-001',
    name: 'Refrigerant Leakage',
    description: 'Calculate fugitive Scope 1 emissions from refrigerant leakage using the mass-balance method (annual leakage mass × GWP100).',
    category: 'Fugitive - Refrigerants',
    tags: ['scope-1', 'fugitive', 'refrigerant', 'gwp'],
    status: 'active',
    database: 'master',
    ...
    expressions: [
      {
        ...
        sourceURL: 'https://www.ipcc.ch/report/ar6/',
        methodology: 'GHG Protocol Scope 1 - Fugitive emissions; mass-balance approach.',
        isActive: true
      }
    ]
  },
  ...
  // ============================================
  // FORMULA 11: Purchased Goods (dedicated, spend-based)
  // ============================================
  {
    id: 'form-pur-goo-dedicated',
    uid: 'FORM-PUR-GOO-2024-001',
    name: 'Purchased Goods - Spend-based',
    description: 'Calculate Scope 3 Cat. 1 emissions from purchased goods and services using the spend-based method (procurement value × spend EF).',
    category: 'Scope 3 - Purchased Goods',
  ...
  // ============================================
  // FORMULA 12: Capital Goods (dedicated, spend-based)
  // ============================================
  {
    id: 'form-cap-goo-dedicated',
    uid: 'FORM-CAP-GOO-2024-001',
    name: 'Capital Goods - Spend-based',
    description: 'Calculate Scope 3 Cat. 2 emissions from capital expenditure using the spend-based method.',
    category: 'Scope 3 - Capital Goods',
    tags: ['scope-3', 'capital-goods', 'capex', 'upstream'],
    status: 'active',
    database: 'master',
