...
// ISO 14064-1 inventory project + BUs are merged into the arrays below at the
// bottom of this file. (Type-only import in isoBusinessUnits → no runtime cycle.)
...
// ─── ISO 14064-1 inventory project + its business units ─────────────────────
// Folded into the single sources of truth so the BCA project list, the BU
// roster, mockBusinessUnits, and the template validator all see them.
// (Imports are at the top of this file.)
businessUnitsData.push(...(isoBusinessUnits as BusinessUnit[]));
